/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function () {
	...
	t.ya = function () {
		...
		a
			...
			: ((this.cd = f), (this.Yc = document.documentElement.style.overflow), u.d(document, "keydown", u.bind(this, this.lc)), (document.documentElement.style.overflow = "hidden"), u.n(document.body, "vjs-full-window"), this.j("enterFullWindow"), this.j("fullscreenchange"));
		return this;
	};
	t.ob = function () {
		var a = u.Pb.ya;
