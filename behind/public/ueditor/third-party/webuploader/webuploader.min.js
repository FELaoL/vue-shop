	...
	return (
		...
		b("widgets/image", ["base", "uploader", "lib/image", "widgets/widget"], function (a, b, c) {
			...
			return (
				...
				e.extend(b.options, { thumb: { width: 110, height: 110, quality: 70, allowMagnify: !0, crop: !0, preserveHeaders: !1, type: "image/jpeg" }, compress: { width: 1600, height: 1600, quality: 90, allowMagnify: !1, crop: !1, preserveHeaders: !0 } }),
				b.register(
		...
		b("widgets/queue", ["base", "uploader", "queue", "file", "lib/file", "runtime/client", "widgets/widget"], function (a, b, c, d, e, f) {
			var g = a.$,
				...
				i = d.Status;
			return b.register(
				{ "sort-files": "sortFiles", "add-file": "addFiles", "get-file": "getFile", "fetch-file": "fetchFile", "get-stats": "getStats", "get-files": "getFiles", "remove-file": "removeFile", retry: "retry", reset: "reset", "accept-file": "acceptFile" },
				{
					init: function (b) {
						var d,
							e,
		...
		b("runtime/html5/jpegencoder", [], function () {
			function a(a) {
				function b(a) {
					...
					for (var h = [1, 1.387039845, 1.306562965, 1.175875602, 1, 0.785694958, 0.5411961, 0.275899379], i = 0, j = 0; 8 > j; j++) for (var k = 0; 8 > k; k++) (B[i] = 1 / (z[P[i]] * h[j] * h[k] * 8)), (C[i] = 1 / (A[P[i]] * h[j] * h[k] * 8)), i++;
				}
				function c(a, b) {
