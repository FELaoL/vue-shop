...
(function (j, C) {
	...
	h.bubble = x(h.scatter, {
		...
		translate: function () {
			...
			for (a = b.length; a--; ) (c = b[a]), (d = g ? g[a] : 0), (c.negative = c.z < (this.options.zThreshold || 0)), d >= this.minPxSize / 2 ? ((c.shapeType = "circle"), (c.shapeArgs = { x: c.plotX, y: c.plotY, r: d }), (c.dlBox = { x: c.plotX - d, y: c.plotY - d, width: 2 * d, height: 2 * d })) : (c.shapeArgs = c.plotY = c.dlBox = C);
		},
