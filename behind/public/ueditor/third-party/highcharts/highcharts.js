...
(function () {
	...
	function Eb(a, b, c, d) {
		...
		if (u(b)) {
			...
			b = 1;
			h = i[ab]();
			for (var d = i.getTime(), l = i[$a](), m = i[Sa](), p = g ? 0 : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5; d < c; ) e.push(d), j === D[Da] ? (d = bb(h + b * k, 0)) : j === D[Ra] ? (d = bb(h, l + b * k)) : !g && (j === D[ua] || j === D[Za]) ? (d = bb(h, l, m + b * k * (j === D[ua] ? 1 : 7))) : (d += j * k), b++;
			e.push(d);
			n(
				ub(e, function (a) {
	...
	Xa = function (a, b, c) {
		...
		var a = o(a, "%Y-%m-%d %H:%M:%S"),
			...
			k = M.lang,
			l = k.weekdays,
			d = r({ a: l[g].substr(0, 3), A: l[g], d: Ba(h), e: h, b: k.shortMonths[i], B: k.months[i], m: Ba(i + 1), y: j.toString().substr(2, 2), Y: j, H: Ba(f), I: Ba(f % 12 || 12), l: f % 12 || 12, M: Ba(d[qb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ba(d.getSeconds()), L: Ba(t(b % 1e3), 3) }, Highcharts.dateFormats);
				...
				if (ea(a)) (c = a), (q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c]);
					...
					for (c in a)
						if (((d = a[c]), (m = !1), (e = p[c] && p[c].call(this, d, c)), e !== !1 && d !== null)) {
							...
							else if (qa(c, ["x", "y", "width", "height"]) !== -1) (this[c] = d), c === "x" || c === "y" ? (c = { x: "left", y: "top" }[c]) : (d = s(0, d)), this.updateClipping ? ((this[c] = d), this.updateClipping()) : (g[c] = d), (m = !0);
	...
	db.prototype = {
		...
		render: function () {
			...
			if (o) (A = a.getLinePath(o)), a.axisLine ? a.axisLine.animate({ d: A }) : (a.axisLine = c.path(A).attr({ stroke: d.lineColor, "stroke-width": o, zIndex: 7 }).add(a.axisGroup)), a.axisLine[t ? "show" : "hide"]();
	...
	Q.prototype = {
		...
		translate: function () {
			...
			for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || sa(i), k = a.threshold, a = 0; a < g; a++) {
				...
				if (b && this.visible && n && n[m]) (n = n[m]), (p = n.points[this.index]), (q = p[0]), (p = p[1]), q === 0 && (q = o(k, e.min)), e.isLog && q <= 0 && (q = null), (l.percentage = b === "percent" && p), (l.total = l.stackTotal = n.total), (l.stackY = p), n.setOffset(this.pointXOffset || 0, this.barW || 0);
		...
		animate: function (a) {
			...
			if (a) (a = c[h]), (e = c[h + "m"]), a || ((c[h] = a = d.clipRect(r(f, { width: 0 }))), (c[h + "m"] = e = d.clipRect(-99, g ? -c.plotLeft : -c.plotTop, 99, g ? c.chartWidth : c.chartHeight))), b.group.clip(a), b.markerGroup.clip(e), (b.sharedClipKey = h);
			else {
			...
			if (l.enabled || this._hasPointMarkers)
				for (f = b.length; f--; )
					if (((g = b[f]), (d = P(g.plotX)), (e = g.plotY), (k = g.graphic), (i = g.marker || {}), (a = (l.enabled && i.enabled === w) || i.enabled), (m = c.isInsidePlot(t(d), e, c.inverted)), a && e !== w && !isNaN(e) && g.y !== null))
						if (((a = g.pointAttr[g.selected ? "select" : ""]), (h = a.r), (i = o(i.symbol, this.symbol)), (j = i.indexOf("url") === 0), k)) k.attr({ visibility: m ? (Z ? "inherit" : "visible") : "hidden" }).animate(r({ x: d - h, y: e - h }, k.symbolName ? { width: 2 * h, height: 2 * h } : {}));
						else {
							if (m && (h > 0 || j))
		...
		alignDataLabel: function (a, b, c, d, e) {
			var f = this.chart,
				...
				i = o(a.plotY, -999),
				j = b.getBBox();
			if ((a = this.visible && f.isInsidePlot(a.plotX, a.plotY, g))) (d = r({ x: g ? f.plotWidth - i : h, y: t(g ? f.plotHeight - h : i), width: 0, height: 0 }, d)), r(c, { width: j.width, height: j.height }), c.rotation ? ((g = { align: c.align, x: d.x + c.x + d.width / 2, y: d.y + c.y + d.height / 2 }), b[e ? "attr" : "animate"](g)) : (b.align(c, null, d), (g = b.alignAttr), o(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) : o(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)));
			a || b.attr({ y: -999 });
		},
	...
	G = ha(Q, {
		...
		getSegments: function () {
			...
			if (this.options.stacking && !this.cropped) {
				...
				n(c, function (a) {
					if (!k || (g[a] && g[a].y !== null)) g[a] ? b.push(g[a]) : ((h = d.translate(a)), (l = f[a].percent ? (f[a].total ? (f[a].cum * 100) / f[a].total : 0) : f[a].cum), (i = e.toPixels(l, !0)), b.push({ y: null, plotX: h, clientX: h, plotY: i, yBottom: i, onMouseOver: pa }));
				});
				b.length && a.push(b);
