 ...
 * ueditor parse
 * version: 2.0.0
 * build: Wed Dec 06 2017 17:45:32 GMT+0800 (CST)
 */ !(function () {
	!(function () {
		UE = window.UE || {};
		...
		UE.parse.register("insertcode", function (a) {
			...
			if (b.length)
				if ("undefined" == typeof XRegExp) {
					var c, d;
					void 0 !== this.rootPath ? ((c = a.removeLastbs(this.rootPath) + "/third-party/SyntaxHighlighter/shCore.js"), (d = a.removeLastbs(this.rootPath) + "/third-party/SyntaxHighlighter/shCoreDefault.css")) : ((c = this.highlightJsUrl), (d = this.highlightCssUrl)),
						a.loadFile(document, { id: "syntaxhighlighter_css", tag: "link", rel: "stylesheet", type: "text/css", href: d }),
		...
		UE.parse.register("charts", function (a) {
			...
			function f() {
				window.jQuery
					? g()
					: a.loadFile(document, { src: m + "/third-party/jquery-1.10.2.min.js", tag: "script", type: "text/javascript", defer: "defer" }, function () {
							g();
					  });
			}
			function g() {
				window.Highcharts
					? h()
					: a.loadFile(document, { src: m + "/third-party/highcharts/highcharts.js", tag: "script", type: "text/javascript", defer: "defer" }, function () {
							h();
					  });
			}
			function h() {
